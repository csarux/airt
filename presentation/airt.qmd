...
- El sistema establece el modelo minimizando una ***función de coste*** que tiene que ser definida previmente

:::{.callout-tip icon="true"}
## Cálculos de mminimización 
La minimización es proceso programable por los procedimientos de software tradicional
:::

#### Modelos que dependen de varias variables
...
## Detalles de las capas {.samller}

### 🔸 a) Capa de convolución *(solo en redes de imagen)*
...
📌 Analógico a cómo un TSR detecta un artefacto en RM: buscando un patrón.  

📌 **Visual sugerido**: imagen TAC → mapa de bordes con un filtro simple.
